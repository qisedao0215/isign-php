...
$configs = [
    ...
    // 默认JSONP格式返回的处理方法
    'default_jsonp_handler'   => 'QQ853651484',
    // 默认JSONP处理方法
    'var_jsonp_handler'       => 'QQ853651484',
    // 默认时区
    ...
    'cmf_default_theme'       => '97013266',
    'cmf_admin_theme_path'    => 'themes/',
    'cmf_admin_default_theme' => 'admin_simpleboot3',
    //路径
    //项目绝对目录
    'absolute_path' => '/www/wwwroot/supersign.makemeng.com/',
];
