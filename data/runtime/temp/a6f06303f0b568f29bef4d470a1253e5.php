<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:37:"themes/97013266/portal/supposted.html";i:1588572378;s:32:"themes/97013266/public/head.html";i:1588572378;s:36:"themes/97013266/public/function.html";i:1588572378;s:31:"themes/97013266/public/nav.html";i:1588572378;s:34:"themes/97013266/public/footer.html";i:1588572378;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__TMPL__/public/assets/js/plist_parser.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5eb12e6a4bb96,null,false);
 ?>
</head>
...
function __parse_navigation773ea103def200c9f5bb27f40b14e181($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation773ea103def200c9f5bb27f40b14e181';
...
if(''==''): ?>
    <?php echo __parse_navigation773ea103def200c9f5bb27f40b14e181($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation773ea103def200c9f5bb27f40b14e181($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer" style="bottom: 0px;height: 80px;background:#ECECEC;width: -webkit-fill-available">
    <?php 
    \think\Hook::listen('footer_start',$temp5eb12e6a4bba4,null,false);
 ?>
    <div class="links">
        <?php
