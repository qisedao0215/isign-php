<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:39:"themes/97013266/portal/supper_sign.html";i:1588572378;s:32:"themes/97013266/public/head.html";i:1588572378;s:36:"themes/97013266/public/function.html";i:1588572378;s:31:"themes/97013266/public/nav.html";i:1588572378;s:34:"themes/97013266/public/footer.html";i:1588572378;s:35:"themes/97013266/public/scripts.html";i:1588572378;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__TMPL__/public/assets/js/plist_parser.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5eb12e56eb468,null,false);
 ?>
    <style>
        .bogo-content {
            margin-top: 100px;
...
function __parse_navigation6b75cb07c3310b410387255bb39e2483($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation6b75cb07c3310b410387255bb39e2483';
...
if(''==''): ?>
    <?php echo __parse_navigation6b75cb07c3310b410387255bb39e2483($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation6b75cb07c3310b410387255bb39e2483($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer" style="bottom: 0px;height: 80px;background:#ECECEC;width: -webkit-fill-available">
    <?php 
    \think\Hook::listen('footer_start',$temp5eb12e56eb471,null,false);
 ?>
    <div class="links">
        <?php
