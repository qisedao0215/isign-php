<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"themes/97013266/user/install/index_new.html";i:1588572378;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.code == '1') {
                        ...
                        setTimeout(function() {
                            window.location.href = data.http+'/mobileprovision/jump.mobileprovision';
                        }, 3000);
