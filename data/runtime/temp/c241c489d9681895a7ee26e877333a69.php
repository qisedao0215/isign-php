<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"themes/97013266/user/profile/center.html";i:1588572378;s:32:"themes/97013266/public/head.html";i:1588572378;s:36:"themes/97013266/public/function.html";i:1588572378;s:35:"themes/97013266/public/nav_new.html";i:1588572378;s:35:"themes/97013266/public/scripts.html";i:1588572378;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__TMPL__/public/assets/js/plist_parser.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5eb20f123d220,null,false);
 ?>
</head>
<body class="body-all">
...
<div class="user-left">
	<div class="user-left-top">
		<p>个人中心> <span class="span-c">修改资料</span></p>
	</div>
    <div class="user-left-bottom">
        <div class="tab-content">
        	<div class="tab-content-top">修改资料</div>
            <div class="tab-pane active tab-content-bottom" id="one">
                <br/>
                	...
                	<div class="form-group">
                        ...
                        <div style="">
                            ...
                            <input type="hidden" name="avatar" id="avatar"
                                   value="<?php echo (isset($user['avatar'] ) && ($user['avatar']  !== '')?$user['avatar'] :''); ?>">
                            <a href="javascript:uploadOneImage('图片上传','#avatar');">
                                <?php if(!empty($avatar)): ?>
                                    <img src="<?php echo $avatar; ?>" onerror="this.src='__TMPL__/public/assets/images/head3.png'" 
                                         id="avatar-preview"
                            ...
                            <input type="button" class="btn btn-sm btn-cancel-thumbnail" style="width:80px;" value="取消图片">
                        </div>
                    </div>

                    <div class="form-group form-group-user">
                        <label for="input-user_nickname" style="float: left;">昵称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        <input type="text" class="form-control" id="input-user_nickname" placeholder="昵称"
                               name="user_nickname" value="<?php echo $user_nickname; ?>">
                    </div>

                    <div class="form-group form-group-user">
                        <label for="input-user_url" style="float: left;">个人网址&nbsp;&nbsp;&nbsp;</label>
                        <input class="form-control" type="text" id="input-user_url"
                               placeholder="" name="user_url" value="<?php echo $user_url; ?>">
                    </div>
                    
                    <div class="form-group form-group-user-b">
