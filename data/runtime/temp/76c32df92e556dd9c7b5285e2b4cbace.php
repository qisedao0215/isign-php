<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"themes/admin_simpleboot3/admin/certificate/add_certificate.html";i:1588572378;s:43:"themes/admin_simpleboot3/public/header.html";i:1588572378;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('certificate/add_certificate'); ?>">添加证书</a></li>
    </ul>

    <div class="wrap js-check-wrap">
        <form class="form-horizontal" action="<?php echo url('certificate/save_certificate'); ?>" method="post"
